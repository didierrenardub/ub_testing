...
public abstract class CJavaTier1Exercise1ArithmeticOperations extends CExercise
{
    ...
    public final List<CTestOutput> run()
    {
        ...
        this.testMultiply(o);
        this.testDivide(o);
        this.testSquarePower(o);

        return o;
    }

    private void testAdd(List<CTestOutput> o)
    {
        ...
        for(int i = 0; i < addTests.get(0).size(); i++)
        {
            ...
            try
            {
                result = this.add(addTests.get(0).get(i), addTests.get(1).get(i));
            }
            catch(Exception e)
            {
    ...
    private void testSubtract(List<CTestOutput> o)
    {
        ...
        for(int i = 0; i < subtractTests.get(0).size(); i++)
        {
            ...
            try
            {
                result = this.subtract(subtractTests.get(0).get(i), subtractTests.get(1).get(i));
            }
            catch(Exception e)
            {
    ...
    private void testMultiply(List<CTestOutput> o)
    {
        ...
        for(int i = 0; i < multiplyTests.get(0).size(); i++)
        {
            ...
            try
            {
                result = this.multiply(multiplyTests.get(0).get(i), multiplyTests.get(1).get(i));
            }
            catch(Exception e)
            {
    ...
    private void testDivide(List<CTestOutput> o)
    {
        ...
        for(int i = 0; i < divideTests.get(0).size(); i++)
        {
            ...
            try
            {
                result = this.divide(divideTests.get(0).get(i), divideTests.get(1).get(i));
            }
    ...
    private void testSquarePower(List<CTestOutput> o)
    {
        ...
        for(int i = 0; i < squarePowerTests.get(0).size(); i++)
        {
            ...
            try
            {
                result = this.squarePower(squarePowerTests.get(0).get(i));
            }
            catch(Exception e)
            {
