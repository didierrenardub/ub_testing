...
class Students2020(Students):
    def __init__(self):
        ...
        self.pablo().add_exercise('2m1',    10.0)
        ...
        self.alan().grade_class(        4, 10, 10,  8,  3,  0,  0,  0)
        self.ricardo().grade_class(     4, 10, 10,  0,  0,  0,  0,  0)
        self.matias().grade_class(      4, 10, 10,  0,  0,  0,  0,  0)

        # class 5                       c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(       5, 10,  0,  1,  0,  0,  0,  0)
        self.federico().grade_class(    5, 10,  0,  1,  0,  0,  0,  0)
        self.victoria().grade_class(    5, 10,  0,  1,  0,  0,  0,  0)
        self.manuel().grade_class(      5, 10,  0,  1,  0,  0,  0,  0)
        self.cristian().grade_class(    5, 10,  0,  1,  0,  0,  0,  0)
        self.luis().grade_class(        5, 10,  0,  1,  0,  0,  0,  0)
        self.franco().grade_class(      5,  1,  0,  1,  0,  0,  0,  0)
        self.yainy().grade_class(       5, 10,  0,  1,  0,  0,  0,  0)
        self.francisco().grade_class(   5, 10,  0,  1,  0,  0,  0,  0)
        self.nazareno().grade_class(    5,  1,  0,  1,  0,  0,  0,  0)
        self.alan().grade_class(        5, 10,  0,  1,  0,  0,  0,  0)
        self.ricardo().grade_class(     5, 10,  0,  1,  0,  0,  0,  0)
        self.matias().grade_class(      5, 10,  0,  1,  0,  0,  0,  0)

        # class 6                       c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(       6,  1,  0,  1,  0,  0,  0,  0)
        self.federico().grade_class(    6, 10,  0,  1,  0,  0,  0,  0)
        self.victoria().grade_class(    6,  1,  0,  1,  0,  0,  0,  0)
        self.manuel().grade_class(      6,  1,  0,  1,  0,  0,  0,  0)
        self.cristian().grade_class(    6, 10,  0,  1,  0,  0,  0,  0)
        self.luis().grade_class(        6, 10,  0,  1,  0,  0,  0,  0)
        self.franco().grade_class(      6,  1,  0,  1,  0,  0,  0,  0)
        self.yainy().grade_class(       6, 10,  0,  1,  0,  0,  0,  0)
        self.francisco().grade_class(   6, 10,  0,  1,  0,  0,  0,  0)
        self.nazareno().grade_class(    6,  1,  0,  1,  0,  0,  0,  0)
        self.alan().grade_class(        6, 10,  0,  1,  0,  0,  0,  0)
        self.ricardo().grade_class(     6, 10,  0,  1,  0,  0,  0,  0)
        self.matias().grade_class(      6, 10,  0,  1,  0,  0,  0,  0)
        ...
        #self.ricardo().grade_class(     7,  0,  0,  0,  0,  0,  0,  0)
