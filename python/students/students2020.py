...
class Students2020(Students):
    def __init__(self):
        ...
        self.victoria().grade_class(    8,  4,  0,  0,  0,  0,  0,  0)
        self.manuel().grade_class(      8,  1,  0,  0,  0,  0,  0,  0)
        self.cristian().grade_class(    8, 10,  0,  0,  0,  0,  0,  0)
        self.luis().grade_class(        8, 10,  0,  0,  0,  0,  0,  0)
        self.franco().grade_class(      8,  1,  0,  0,  0,  0,  0,  0)
        ...
        self.ricardo().grade_class(     8,  1,  0,  0,  0,  0,  0,  0)
        self.matias().grade_class(      8, 10,  0,  0,  0,  0,  0,  0)

        # class 9 (exam)                c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(       9, 10, 10,  0,  0,  0,  0,  0)
        self.federico().grade_class(    9, 10, 10,  0,  0,  0,  0,  0)
        self.victoria().grade_class(    9, 10, 10,  0,  0,  0,  0,  0)
        self.manuel().grade_class(      9,  1,  0,  0,  0,  0,  0,  0)
        self.cristian().grade_class(    9, 10, 10,  0,  0,  0,  0,  0)
        self.luis().grade_class(        9, 10, 10,  0,  0,  0,  0,  0)
        self.franco().grade_class(      9,  1,  0,  0,  0,  0,  0,  0)
        self.yainy().grade_class(       9, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class(   9, 10, 10,  0,  0,  0,  0,  0)
        self.nazareno().grade_class(    9,  1,  0,  0,  0,  0,  0,  0)
        self.alan().grade_class(        9, 10, 10,  0,  0,  0,  0,  0)
        self.ricardo().grade_class(     9,  6,  4,  0,  0,  0,  0,  0)
        self.matias().grade_class(      9, 10, 10,  0,  0,  0,  0,  0)

        # class 10                      c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(      10, 10, 10,  0,  0,  0,  0,  0)
        self.federico().grade_class(   10, 10, 10,  0,  0,  0,  0,  0)
        self.victoria().grade_class(   10,  4, 10,  0,  0,  0,  0,  0)
        self.manuel().grade_class(     10, 10, 10,  0,  0,  0,  0,  0)
        self.cristian().grade_class(   10, 10, 10,  0,  0,  0,  0,  0)
        self.luis().grade_class(       10, 10, 10,  0,  0,  0,  0,  0)
        self.franco().grade_class(     10, 10, 10,  0,  0,  0,  0,  0)
        self.yainy().grade_class(      10, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class(  10, 10, 10,  0,  0,  0,  0,  0)
        self.nazareno().grade_class(   10,  1,  0,  0,  0,  0,  0,  0)
        self.alan().grade_class(       10, 10, 10,  0,  0,  0,  0,  0)
        self.ricardo().grade_class(    10,  9, 10,  0,  0,  0,  0,  0)
        self.matias().grade_class(     10, 10, 10,  0,  0,  0,  0,  0)

        # class 11                      c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(      11, 10,  0,  0,  0,  0,  0,  0)
        ...
        self.cristian().grade_class(   11, 10,  0,  0,  0,  0,  0,  0)
        self.luis().grade_class(       11, 10,  0,  0,  0,  0,  0,  0)
        self.franco().grade_class(     11, 10,  0,  0,  0,  0,  0,  0)
        self.yainy().grade_class(      11, 10,  0,  0,  0,  0,  0,  0)
        self.francisco().grade_class(  11, 10,  0,  0,  0,  0,  0,  0)
        self.nazareno().grade_class(   11,  1,  0,  0,  0,  0,  0,  0)
        self.alan().grade_class(       11, 10,  0,  0,  0,  0,  0,  0)
        self.ricardo().grade_class(    11,  9,  0,  0,  0,  0,  0,  0)
        self.matias().grade_class(     11, 10,  0,  0,  0,  0,  0,  0)

        # class 12                      c   a   p  mp  ms  op  os   q
        self.pablo().grade_class(      12, 10, 10,  0,  0,  0,  0,  0)
        self.federico().grade_class(   12, 10, 10,  0,  0,  0,  0,  0)
        self.victoria().grade_class(   12,  7, 10,  0,  0,  0,  0,  0)
        self.manuel().grade_class(     12, 10, 10,  0,  0,  0,  0,  0)
        self.cristian().grade_class(   12, 10, 10,  0,  0,  0,  0,  0)
        self.luis().grade_class(       12, 10, 10,  0,  0,  0,  0,  0)
        self.franco().grade_class(     12, 10, 10,  0,  0,  0,  0,  0)
        self.yainy().grade_class(      12, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class(  12, 10, 10,  0,  0,  0,  0,  0)
        self.nazareno().grade_class(   12,  1,  0,  0,  0,  0,  0,  0)
        self.alan().grade_class(       12, 10, 10,  0,  0,  0,  0,  0)
        self.ricardo().grade_class(    12,  1,  0,  0,  0,  0,  0,  0)
        self.matias().grade_class(     12, 10, 10,  0,  0,  0,  0,  0)

        # class 13                      c   a   p  mp  ms  op  os   q (exam)
