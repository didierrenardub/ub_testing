...
class Students2020(Students):
    def __init__(self):
        ...
        self.federico().grade_class(    2, 10, 10,  1,  0,  0,  0,  0)
        self.victoria().grade_class(    2, 10, 10,  1,  0,  0,  0,  0)
        self.manuel().grade_class(      2,  1,  0,  1,  0,  0,  0,  0)
        self.cristian().grade_class(    2, 10, 10, 10,  7,  0,  0,  0)
        self.luis().grade_class(        2, 10, 10,  1,  0,  0,  0,  0)
        ...
        self.ricardo().grade_class(     2, 10, 10,  1,  0,  0,  0,  0)
        ...
        self.victoria().grade_class(    3,  0,  0,  5, 10,  0,  0,  0)
        self.manuel().grade_class(      3,  0,  0,  0,  0,  0,  0,  0)
        self.cristian().grade_class(    3,  0,  0,  0,  0,  0,  0,  0)
        self.luis().grade_class(        3,  0,  0,  6, 10,  0,  0,  0)
        self.franco().grade_class(      3,  0,  0, 10, 10,  0,  0,  0)
        self.yainy().grade_class(       3,  0,  0, 10, 10,  0,  0,  0)
        self.francisco().grade_class(   3,  0,  0,  0,  0,  0,  0,  0)
        self.nazareno().grade_class(    3,  0,  0,  0,  0,  0,  0,  0)
        self.alan().grade_class(        3,  0,  0, 10, 10,  0,  0,  0)
        self.ricardo().grade_class(     3,  0,  0,  0,  0,  0,  0,  0)
        self.matias().grade_class(      3,  0,  0, 10, 10,  5, 10,  0)
        ...
        #self.ricardo().grade_class(     4,  0,  0,  0,  0,  0,  0,  0)
        ...
        #self.ricardo().grade_class(     5,  0,  0,  0,  0,  0,  0,  0)
        ...
        #self.ricardo().grade_class(     6,  0,  0,  0,  0,  0,  0,  0)
