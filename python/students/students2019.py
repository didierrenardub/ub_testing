...
class Students2019(Students):
    def __init__(self):
        ...
        self.federico().grade_class(   5, 10, 10,  1,  0,  0,  0,  8)
        self.andres().grade_class(     5, 10, 10,  1,  0,  0,  0,  1)
        self.francisco().grade_class(  5, 10, 10,  1,  0,  0,  0,  4)
        self.diego().grade_class(      5, 10, 10,  1,  0,  0,  0,  1)
        self.damian().grade_class(     5,  1,  0,  1,  0,  0,  0,  0)
        self.rocio().grade_class(      5,  1,  0,  1,  0,  0,  0,  0)
        self.joaquin().grade_class(    5, 10, 10,  1,  0,  0,  0, 10)
        self.gabriel().grade_class(    5, 10, 10,  1,  0,  0,  0,  9)

        self.belen().add_exercise('5m', 7)
        self.federico().add_exercise('5m', 10)
        ...
        self.federico().grade_class(   6, 10, 10, 10, 10,  0,  0,  0)
        self.andres().grade_class(     6, 10, 10, 10,  6,  0,  0,  0)
        self.francisco().grade_class(  6, 10, 10,  1,  0,  0,  0,  0)
        self.diego().grade_class(      6, 10, 10, 10,  8,  0,  0,  0)
        self.damian().grade_class(     6,  1,  0,  1,  0,  0,  0,  0)
        self.rocio().grade_class(      6, 10, 10,  1,  0,  0,  0,  0)
        self.joaquin().grade_class(    6, 10, 10,  1,  0,  0,  0,  0)
        self.gabriel().grade_class(    6,  1,  0,  1,  0,  0,  0,  0)

        self.belen().add_exercise('6m', 4)
        self.federico().add_exercise('6m', 4)
        self.francisco().add_exercise('6m', 4)
        ...
        self.federico().grade_class(   7, 10, 10,  3,  3,  0,  0,  0)
        self.andres().grade_class(     7, 10, 10,  1,  0,  0,  0,  0)
        self.francisco().grade_class(  7, 10, 10,  3,  3,  0,  0,  0)
        self.diego().grade_class(      7, 10, 10,  3,  3,  0,  0,  0)
        self.damian().grade_class(     7,  1, 10,  1,  0,  0,  0,  0)
        self.rocio().grade_class(      7, 10, 10,  1,  0,  0,  0,  0)
        ...
        self.federico().grade_class(   8, 10, 10,  0,  0,  0,  0,  0)
        self.andres().grade_class(     8, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class(  8, 10, 10,  0,  0,  0,  0,  0)
        self.diego().grade_class(      8, 10, 10,  0,  0,  0,  0,  0)
        self.damian().grade_class(     8,  1, 10,  0,  0,  0,  0,  0)
        self.rocio().grade_class(      8, 10, 10,  0,  0,  0,  0,  0)
        ...
        self.federico().grade_class(   9, 10, 10,  0,  0,  0,  0,  0)
        self.andres().grade_class(     9, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class(  9, 10, 10,  0,  0,  0,  0,  0)
        self.diego().grade_class(      9, 10, 10,  0,  0,  0,  0,  0)
        self.damian().grade_class(     9,  1,  0,  0,  0,  0,  0,  0)
        self.rocio().grade_class(      9, 10,  3,  0,  0,  0,  0,  0)
        ...
        self.franco().grade_class(    10, 10,  0,  0,  0,  0,  0,  0)
        self.belen().grade_class(     10, 10,  0,  0,  0,  0,  0,  0)
        self.federico().grade_class(  10, 10,  0,  0,  0,  0,  0,  0)
        self.andres().grade_class(    10, 10,  0,  0,  0,  0,  0,  0)
        self.francisco().grade_class( 10, 10,  0,  0,  0,  0,  0,  0)
        self.diego().grade_class(     10, 10,  0,  0,  0,  0,  0,  0)
        self.damian().grade_class(    10,  1,  0,  0,  0,  0,  0,  0)
        self.rocio().grade_class(     10,  1,  0,  0,  0,  0,  0,  0)
        self.joaquin().grade_class(   10, 10,  0,  0,  0,  0,  0,  0)
        self.gabriel().grade_class(   10,  1,  0,  0,  0,  0,  0,  0)

        # class 11                      c   a   p  mp  ms  op  os   q
        self.alex().grade_class(      11, 10,  0,  0,  0,  0,  0,  0)
        self.franco().grade_class(    11,  1,  0,  0,  0,  0,  0,  0)
        self.belen().grade_class(     11, 10,  0,  0,  0,  0,  0,  0)
        self.federico().grade_class(  11, 10,  0,  0,  0,  0,  0,  0)
        self.andres().grade_class(    11, 10,  0,  0,  0,  0,  0,  0)
        self.francisco().grade_class( 11, 10,  0,  0,  0,  0,  0,  0)
        self.diego().grade_class(     11, 10,  0,  0,  0,  0,  0,  0)
        self.damian().grade_class(    11,  1,  0,  0,  0,  0,  0,  0)
        self.rocio().grade_class(     11, 10,  0,  0,  0,  0,  0,  0)
        self.joaquin().grade_class(   11, 10,  0,  0,  0,  0,  0,  0)
