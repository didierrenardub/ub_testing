...
class Students2019(Students):
    def __init__(self):
        ...
        self.andres().grade_class(    10, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class( 10, 10, 10,  0,  0,  0,  0,  0)
        self.diego().grade_class(     10, 10, 10,  0,  0,  0,  0,  0)
        ...
        self.federico().grade_class(  11, 10, 10,  0,  0,  0,  0,  0)
        self.andres().grade_class(    11, 10, 10,  0,  0,  0,  0,  0)
        self.francisco().grade_class( 11, 10, 10,  0,  0,  0,  0,  0)
        self.diego().grade_class(     11, 10, 10,  0,  0,  0,  0,  0)
        self.damian().grade_class(    11,  1,  0,  0,  0,  0,  0,  0)
        self.rocio().grade_class(     11, 10, 10,  0,  0,  0,  0,  0)
